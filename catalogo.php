    ...
    <main class="container mt-5">
        ...
        <div class="d-flex gap-4 justify-content-center flex-wrap">
            ...
            <?php
                ...
                foreach ($animais as  $anm) : #Abertura do laço
            ?>
            <div class="card">
                <!-- Imagens -->
                 <?php
                ...
                <div id="carouselAnimal-<?=$anm->id_animal?>" class="carousel slide">
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselAnimal-<?= $anm->id_animal?>"
                        data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carouselAnimal-<?= $anm->id_animal?>"
                        data-bs-slide="next">
            ...
            <!-- Finaliza o laço dos animais -->
                <?php endforeach; ?>
        </div>
                    <?php 
                    foreach($animais as $anm):
                     ?>
        <div class="modal fade" id="animalModal-<?=$anm->id_animal ?>" tabindex="-1" aria-labelledby="animalModalLabel-<?=$anm->id_animal ?>" aria-hidden="true">
